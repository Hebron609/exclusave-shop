<template>
  <section class="pt-40 text-gray-900 bg-white">
    <div class="max-w-[1440px] mx-auto px-6">
      <!-- Text -->
      <div>
        <h1
          class="text-3xl font-medium leading-tight tracking-tight md:text-6xl"
        >
        Elevate Your Style.<br />
           <span class="text-gray-800">Experience ExcluSave.</span>
        </h1>
      </div>
    </div>
...
<div class="flex flex-col md:flex-row items-start justify-between max-w-[1440px] mx-auto px-6">
  ...
  <div class="flex-shrink-0 mt-6 md:mt-0">
    ...
    <div class="w-full max-w-[1440px] mx-auto px-6 mt-20">
      <video
        src="/src/assets/video/exclu-save-video.mp4"
        autoplay
        muted
        loop
        playsinline
        class="object-cover rounded-2xl brightness-79 max-w-[1440px] h-auto w-full"
      ></video>
    </div>
  </section>
</template>
